...
export default function VintedDetail14Section() {
  ...
  return (
    <section id="vinted-detail-14" className="bg-white leading-[0] relative w-full h-full text-black" data-name="MacBook Pro 14' - 34" data-node-id="237:5">
      ...
      >
        <p className="mb-0">This project further sharpened my skills in user research, information architecture, UI design, and prototyping. It became particularly clear how essential an early, shared style guide and a clearly defined user flow are.</p>
        <p>Working on research-based solutions, instead of "just designing", reflects exactly the design ethos of HfG: user-oriented, reflective, systematic.</p>
      </div>
    </section>
  );
}
